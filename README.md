...
**Versión pública actual:** `v0.16.0` · **Estado:** validación de desarrollo · **No es asesoría de inversión.**
...
- 318 pruebas automatizadas, Ruff y Pyright sin errores, y nueve etapas de linaje verificadas.
